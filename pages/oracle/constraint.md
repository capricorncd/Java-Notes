...
![rename-constraint-name](/img/oracle/rename-constraint-name.png)
...
![table-main-slave](/img/oracle/table-main-slave.png)
...
![create-table-check](/img/oracle/create-table-check.png)
